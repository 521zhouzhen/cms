...
public class BaseUserServiceImpl implements IBaseUserService {
    ...
    public void setRoles(long id, List<Long> roles) {
    	...
    	user_RoleExample.createCriteria().andIdEqualTo(id);
    	List<User_Role> list2 = mapper.selectByExample(user_RoleExample);
    	for(User_Role user_Role:list2) {
    		long id1=user_Role.getId();
